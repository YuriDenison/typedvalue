...
class StringSetValue @JvmOverloads constructor(delegate: KeyValueDelegate, key: String, defaultValue: Set<String> = emptySet()) : TypedValue<Set<String>>(delegate, key, defaultValue) {
